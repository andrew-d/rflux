...
describe("Dispatcher", function() {
    ...
    describe('waitFor', function() {
        ...
        it('will detect an indirect circular dependency', function() {
            var store1 = {
            ...
            var store2 = {
                __handleAction__: function() {
                    this.dispatcher.waitFor(this, ['Store3'], function() {});
                },
            };
            var store3 = {
                __handleAction__: function() {
                    this.dispatcher.waitFor(this, ['Store1'], function() {});
                },
            };
            ...
            // TODO: verify the exception raised
            expect(function() {
                dispatcher.dispatch({type: 'foo'});
            }).toThrow();
        });
